...
const NavBar: React.FC<NavBarProps> = () => {
  ...
  return (
    <div>
      ...
      {/* Mobile Sidebar */}
      <div
        className={`fixed top-0 right-0 h-full w-[75vw] bg-gradient-to-b from-blue-600 to-purple-600 overflow-y-auto pb-10 shadow-xl transform ${
        ...
        <div className="mt-8 px-4 space-y-4">
          {mainLinks.map((link) => (
            <NavLink
              ...
              onClick={toggleMenu}
              className={({ isActive }) => 
                `${navLinkStyles} ${isActive ? activeNavLinkStyles : ""} text-lg`
              }
            >
              {link.icon}
              {link.name}
