      ...
      try {
        ...
        setError(
          error instanceof Error
            ? error.message
            : "Failed to load learner information"
        );
        setLearnerInfo(null);
      }
    };
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex-shrink-0">
              <span className="h-8 w-8 rounded-full bg-purple-600 text-white flex items-center justify-center">
                {learnerInfo.firstName?.[0]}
                {learnerInfo.lastName?.[0]}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg border border-purple-100">
              ...
              <InfoItem
                label="Full Name"
                value={`${learnerInfo.firstName} ${learnerInfo.lastName}`}
              />
              <InfoItem
                label="Email"
                value={learnerInfo.email || "Not specified"}
              />
              <InfoItem
                label="Learning Style"
                value={learnerInfo.preferredLearningStyle}
              />
              <InfoItem
                label="Location"
                value={learnerInfo.location || "Not specified"}
              />
            </div>
